...
| ------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------ |
| `CONTINUE_METRICS_ENABLED`      | Enables OTEL telemetry collection (`0` to disable, `1` to enable, takes precedence) | `0`, `1`                             |
| `CONTINUE_CLI_ENABLE_TELEMETRY` | Enables OTEL telemetry collection (legacy, still supported)                         | `1`                                  |
